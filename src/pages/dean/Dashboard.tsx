...
export default function DeanDashboard() {
  ...
  const stats = [
    { label: 'Total Students', value: '2,450', icon: '👥', color: '#2196F3' },
    { label: 'Departments', value: '12', icon: '🏘️', color: '#4CAF50' },
    { label: 'Programs', value: '34', icon: '📚', color: '#FF9800' },
    { label: 'Pending Approvals', value: '8', icon: '✅', color: '#F44336' },
  ];

  return (
    <div className="page-container">
      <div className="page-header">
        <h1 className="page-title">Faculty Dean Dashboard</h1>
        <p className="page-subtitle">Manage faculty operations and monitor academic performance.</p>
      </div>
